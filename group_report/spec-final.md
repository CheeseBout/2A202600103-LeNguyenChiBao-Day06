**Nhóm**: C401 - Z1
**Track**: Vinmec
**Problem statement:** Người dùng muốn đặt lịch khám tại Vinmec nhưng phải tự nhập nhiều thông tin, chọn chuyên khoa/bác sĩ/cơ sở, dẫn đến trải nghiệm rườm rà và có thể phải xếp hàng lâu khi đến viện. AI sẽ hỗ trợ hội thoại thông minh, gợi ý chuyên khoa phù hợp với triệu chứng, điền form nháp và chỉ gửi yêu cầu đặt lịch sau khi người dùng xác nhận toàn bộ thông tin.

## AI Product Canvas

- **User / Value:**
  - Toàn bộ người dùng muốn đặt lịch khám chữa bệnh tại VinMec
  ...
  - Value: AI chat hỏi từng bước, gợi ý chuyên khoa dựa trên triệu chứng, điền nháp form và hiển thị tóm tắt trước khi user xác nhận đặt lịch.

- **Trust:**
  - AI chỉ gợi ý chuyên khoa theo hướng tham khảo, không chẩn đoán bệnh.
  - Hiển thị toàn bộ thông tin cuộc hẹn (tên, SĐT, ngày giờ, cơ sở, chuyên khoa, bác sĩ, triệu chứng) trước khi đặt.
...
| **Correction — user sửa** | User sửa yêu cầu sau khi AI đề xuất | User gõ: "Không, tôi muốn khám chấn thương chỉnh hình". AI cập nhật danh sách bác sĩ tương ứng |
